...
# def make_cluster_tree(treefile, num_tips, taxon_dict, figdir):
...
#     offset = 0
#     space_offset = My_Tree.treeHeight/10
#     absolute_x_axis_size = My_Tree.treeHeight+space_offset+space_offset + My_Tree.treeHeight 
    
#     tipsize = 40
#     c_func=lambda k: 'dimgrey' ## colour of branches
#     l_func=lambda k: 'lightgrey' ## colour of dotted lines
#     s_func = lambda k: tipsize*5 if k.name in taxon_dict else (0 if k.node_number > 1 else tipsize)
#     z_func=lambda k: 100
...
#             else:
#                 ax.text(text_start, y, name, size=font_size_func(k), ha="left", va="center", fontweight="light")
